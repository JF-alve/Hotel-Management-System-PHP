...
<head>
  <meta charset="UTF-8">
  <title>NOA CONVENTION ADMIN</title>
...
<body>
    ...
    <div id="login">
      ...
      <form method="post">
        ...
        <fieldset class="clearfix">
          ...
          <p><span class="fontawesome-user"></span><input type="text" name="user" value="Username"
  ...
  <div class="bottom">
    <h3><a href="../index.php">NOA CONVENTION HOMEPAGE</a></h3>
  </div>

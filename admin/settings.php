...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="home.php"><i class="fa fa-desktop"></i>Homepage</a>
                    </li>
        ...
        <div class='panel panel-primary text-center no-boder bg-color-blue'>
            ...
            <p><strong>Room Type:</strong> " . $row['type'] . "</p>
                <button class='btn btn-info' onclick=\"window.location.href='room_details.php?type=" . $row['type'] . "&bedding=" . $row['bedding'] . "'\">
                    View Details
                </button>
                <a href='update_room_status.php?id=" . $row['id'] . "'>
